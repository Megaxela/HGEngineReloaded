...
namespace HG::Utils::Base64
{
    ...
    typename std::enable_if<
        sizeof(Byte) == 1
    >::type Encode(const Byte* source, std::size_t sourceSize, std::string& target)
    {
        std::size_t i = 0;
        std::size_t j = 0;
    ...
    typename std::enable_if<
        sizeof(Byte) == 1,
        std::string
    >::type Encode(const Byte* source, std::size_t sourceSize)
    {
        std::string target;
    ...
    typename std::enable_if<
        sizeof(Byte) == 1
    >::type Encode(const bytearray_processor<Byte, Allocator>& processor, std::string& result)
    {
    ...
    typename std::enable_if<
        sizeof(InByte) == 1 && sizeof(OutByte) == 1
    >::type Decode(const InByte* base64, std::size_t in_size, std::vector<OutByte>& target)
    {
        std::size_t i = 0;
        std::size_t j = 0;
    ...
    typename std::enable_if<
        sizeof(InByte) == 1 && sizeof(OutByte) == 1,
        std::vector<OutByte>
    >::type Decode(const InByte* base64, std::size_t in_size)
    {
    ...
    typename std::enable_if<
        sizeof(Byte) == 1
    >::type Decode(const std::string& base64, std::vector<Byte>& target)
    {
    ...
    typename std::enable_if<
        sizeof(Byte) == 1,
        std::vector<Byte>
    >::type Decode(const std::string& base64)
    {
    ...
    typename std::enable_if<
        sizeof(Byte) == 1
    >::type Decode(const std::string_view& base64, std::vector<Byte>& target)
    {
    ...
    typename std::enable_if<
        sizeof(Byte) == 1,
        std::vector<Byte>
    >::type Decode(const std::string_view& base64)
    {
        std::vector<Byte> target;

                 ...
                 playrho::d2::Transformation xf)
{
    ...
    const auto fillColor = HG::Utils::Color{0.5f * color.redF(), 0.5f * color.greenF(), 0.5f * color.blueF(), 0.5f};
    ...
    const auto skinColor = HG::Utils::Color{color.redF() * 0.6f, color.greenF() * 0.6f, color.blueF() * 0.6f};
...
static bool
Draw(HG::Physics::PlayRho::DebugDraw& drawer, const playrho::d2::Body& body, bool skins, const FixtureSet& selected)
{
    auto found               = false;
...
static void Draw(HG::Physics::PlayRho::DebugDraw& drawer, const playrho::d2::Joint& joint)
{
...
static void Draw(HG::Physics::PlayRho::DebugDraw& drawer, const playrho::d2::AABB& aabb, const HG::Utils::Color& color)
{
...
{
    m_stepConfiguration.SetTime(deltaTime.count() / 1000000.0f);

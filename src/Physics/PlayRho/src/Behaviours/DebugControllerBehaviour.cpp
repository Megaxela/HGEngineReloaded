...
void Behaviours::DebugControllerBehaviour::onUpdate()
{
    ...
    if (ImGui::Begin("PlayRho settings", &opened))
    {
        ...
        tooltip(
            "Whether or not to perform any time of impact (TOI) calculations used for doing\n"
        ...
        tooltip(
            "The maximum amount a body can translate in a single step. This represents\n"
        ...
        tooltip(
            "The maximum amount a body can rotate in a single step. This represents\n"

...
HG::Physics::PlayRho::DebugDraw::DebugDraw(HG::Rendering::Base::Gizmos* gizmos) : m_gizmos(gizmos), m_z(1.0f)
{
}
...
void HG::Physics::PlayRho::DebugDraw::drawSegment(const playrho::Length2& p1,
                                                  ...
                                                  const HG::Utils::Color& color)
{
    m_gizmos->line(glm::vec3(p1[0], p1[1], m_z), glm::vec3(p2[0], p2[1], m_z), color);
}

...
public:
    ...
    struct SphereData
    {
        SphereData() : transformation(), dividings(15), radius(1), color()
        {
        }
    ...
    {
        HexahedronData() : transformation(), sideSize(1), color()
        {
        }

        HexahedronData(const HG::Core::Transform& transformation, float sideSize, const HG::Utils::Color& color) :
            transformation(transformation),
            sideSize(sideSize),
            color(color)
        {
    ...
    struct LineData
    {
        LineData() : begin(), beginColor(), end(), endColor()
        {
        }
     ...
     */
    void line(const glm::vec3& from, const glm::vec3& to, HG::Utils::Color color = defaultColor);
     ...
     * @param color Color.
     */
    void circle(const glm::vec3& position, float radius, const HG::Utils::Color& color = defaultColor);
     ...
     * @param color Color.
     */
    void circle(const glm::vec3& position, glm::vec2 size, const HG::Utils::Color& color = defaultColor);
     ...
     */
    void circle(const HG::Core::Transform& transform, glm::vec2 size, uint32_t parts, const HG::Utils::Color& color);

    /**
     * @brief Method for drawing line of multiple segments.
     * @param line Line data.
     */
    void multiLine(const Line& lineData, HG::Utils::Color color = defaultColor);

    /**
     * @brief Method for drawing line.
     * @param lineSegment Line segment.
     */
    void line(const LineSegment& lineSegment, HG::Utils::Color color = defaultColor);
     ...
     */
    void sphere(const HG::Core::Transform& transform, float radius, HG::Utils::Color color = defaultColor);
     ...
     */
    void
    sphere(const HG::Core::Transform& transform, float radius, int dividings, HG::Utils::Color color = defaultColor);
     ...
     */
    void hexahedron(const HG::Core::Transform& transform, float sideSize, HG::Utils::Color color = defaultColor);
